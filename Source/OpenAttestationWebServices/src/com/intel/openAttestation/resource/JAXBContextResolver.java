...
import com.intel.openAttestation.bean.RequestBean;
...
public class JAXBContextResolver implements ContextResolver<JAXBContext> {
    ...
    private Class[] types = {Host.class, AttestationResponseFault.class, PCRValue.class, ReqAttestationBean.class, RequestBean.class, RespAsyncBean.class, RespSyncBean.class};
