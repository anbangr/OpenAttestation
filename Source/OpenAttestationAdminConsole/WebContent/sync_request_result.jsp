...
<td valign="top">
   ...
   <table class="main_div">
     ...
     <tr><td>
	     ...
	     <%RespSyncBean syncBean = new RespSyncBean();
	     List<Host> hosts = new ArrayList<Host>();
	     syncBean = (RespSyncBean)request.getAttribute("syncBean");
	     hosts = syncBean.getHosts();
	     	if (syncBean!=null)
	     	{
	     		String PCRmask = request.getParameter("PCRmask");
	     		hosts= syncBean.getHosts();
	   ...
	   <tr><td colspan="2" class="error_msg_font">&nbsp;<%=request.getAttribute("message")==null? "": request.getAttribute("sync_error")%></td></tr>
     <tr><td class="nav_font" align="center"><input  type="button" value="ok">&nbsp;&nbsp;
     </td></tr>
